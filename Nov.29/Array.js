...
// console.log("engScore>", engScore, type of engScore);
...
// let mathScore = prompt("Enter Math test score");
// console.log("mathScore >", mathScore, typeof mathScore);
// let engScore = prompt("Enter English test score");
// console.log("engScore>", engScore, typeof engScore);
// let avgScore = (parseInt(mathScore) + parseInt(engScore)) / 2;
// console.log(`Average Math, English test score is ${avgScore}.`);
// 그냥 문자를 문자로 쓰고 싶으면 Number()를 안 넣어주면 된다

let mathScore = prompt("Enter Math test score");
console.log("mathScore >", Number(mathScore), typeof Number(mathScore));
let engScore = prompt("Enter English test score");
console.log("engScore>", Number(engScore), typeof Number(engScore));
let avgScore = (parseInt(mathScore) + parseInt(engScore)) / 2;
console.log(`Average Math, English test score is ${avgScore}.`);
// Number()를 넣으면 문자말고 숫자로 바꿔준다
