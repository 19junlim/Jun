//구조 분해 할당
//배열이나 객체의 값을 손쉽게 변수로 분해하여 할당할수있는 문법
// 순서가 중요
// 코드가 더 간결하고 읽기 쉬워짐
...
//undefined: 변수는 선언되었지만 값이 할당 안됨

// 2. 콜론(:) 이용해 새 변수명 선언, 원래의 값을 새 변수에 할당 가능.
...
console.log(lectureInfo); //위 정보들이 나온다
